...
class YoloV8_Class
{
    public:
        ...
        // Alister add 2023-11-22
         // Detection
        // bool getHumanBoundingBox(std::vector<BoundingBox> &_outHumanBboxList,
        //                          float confidenceHuman,
        //                          int videoWidth,
        //                          int videoHeight,
        //                          BoundingBox &fcwROI);

        // bool getBikeBoundingBox(std::vector<BoundingBox> &_outRiderBboxList,
        //                         float confidenceRider,
        //                         int videoWidth,
        //                         int videoHeight,
        //                         BoundingBox &fcwROI);

        // bool getMotorbikeBoundingBox(std::vector<BoundingBox> &_outRiderBboxList,
        //                              float confidenceRider,
        //                              int videoWidth,
        //                              int videoHeight,
        //                              BoundingBox &fcwROI);

        // bool getVehicleBoundingBox(std::vector<BoundingBox> &_outBboxList,
